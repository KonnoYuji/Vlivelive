...
public class VWorldUIManager : MonoBehaviour {
	...
	{					
		MainButton.onClick.AddListener(()=>{
			...
			Camera.main.transform.parent.transform.position = myPos.MyCharOffset(VWorldInitialPos.PlayerStyle.Main) + myPos.GetCameraInitialOffset();
		...
		VipButton.onClick.AddListener(()=>{
			...
			Camera.main.transform.parent.transform.position = myPos.MyCharOffset(VWorldInitialPos.PlayerStyle.Vip) + myPos.GetCameraInitialOffset();
			PlayerSelection.SetActive(false);
#if VR_COMMON
			offset.SetActive(true);
#endif			
		...
		Audience.onClick.AddListener(()=>{
			...
			Camera.main.transform.parent.transform.position = myPos.MyCharOffset(VWorldInitialPos.PlayerStyle.Audience) + myPos.GetCameraInitialOffset();
			PlayerSelection.SetActive(false);
#if VR_COMMON
			offset.SetActive(true);
#endif			
